...
class Manufacturers
{
    public string? GetManufacturer(string wmi)
    {
        ...
        return Lookup.GetValueOrDefault(wmi);
    }
    ...
    private static Dictionary<string, string> CreateDictionary()
    {
        return new()
        {
            ...
            ["JAL"] =
                "Isuzu commercial trucks & Chevrolet commercial trucks made by Isuzu 2016+ & Hino S-series truck made by Isuzu (Incomplete Vehicle - medium duty)",
